export type Color = "primary" | "accent" | "tpu"
...
printables.push({ path: ["Logo_insert"], instruction: { type: "print", color: "primary" }, stl: "STL Files/Minimill Main/Spindle Mount/Logo Insert x1.stl" })
...
// Z Axis
printables.push({ path: ["Z_axis_motor_mount_(1)"], instruction: { type: "print", color: "primary" }, stl: "STL Files/Minimill Main/Z Axis STLs/Z Motor Mount x1.stl" })
printables.push({ path: ["Z_Axis_bearing_block"], instruction: { type: "print", color: "accent" }, stl: "STL Files/Minimill Main/Z Axis STLs/[a] Z Axis Bearing Block x1.stl" })
...
printables.push({ path: ["Ballast_cap"], instruction: { type: "print", color: "primary" }, stl: "STL Files/Minimill Main/Main Column/Ballast Cap x1.stl" })
...
printables.push({ path: ["Z_drag_chain_mount_B"], instruction: { type: "print", color: "accent" }, stl: "STL Files/Minimill Main/Cable Chain Mounts/[a] Z Drag Chain Mount B x1.stl" })
printables.push({ path: ["Z_drag_chain_mount_A_(1)"], instruction: { type: "print", color: "accent" }, stl: "STL Files/Minimill Main/Cable Chain Mounts/[a] Z Drag Chain Mount A x1.stl" })
printables.push({ path: ["Z_Wire_redirect_hook"], instruction: { type: "print", color: "accent" }, stl: "STL Files/Minimill Main/Cable Chain Mounts/[a] Z Cable Redirect Hook x1.stl" })
printables.push({ path: ["Z_axis_cable_chain_backer"], instruction: { type: "print", color: "accent" }, stl: "STL Files/Minimill Main/Cable Chain Mounts/[a} Z Axis Cable Chain Backer x1.stl" });
...
((stl: string, color: Color) => {
  ...
  printables.push({ path: ["Table_bolt_down"], instruction: { type: "print", color: "primary" }, stl })
...
printables.push({ path: ["Skirt_front"], instruction: { type: "print", color: "primary" }, stl: "STL Files/Electronics Table/Skirt Front A Solid x1.stl" })
// STL Files/Electronics Table/Skirt Front A Solid x1.stl
// STL Files/Electronics Table/Skirt Front B E-Stop x1.stl

printables.push({ path: ["Skirt_Rear"], instruction: { type: "print", color: "primary" }, stl: "STL Files/Electronics Table/Rear Skirt A x1.stl" })
