...
printables.push({ path: ["X_axis_Bearing_Block"], instruction: instructions.print.primary, stl: "Minimill Main/X Axis STLs/X Axis Bearing Block x1.stl" })
...
printables.push({ path: ["Y_drag_chain_mount(Mirror)"], instruction: instructions.print.accent, stl: "Minimill Main/Cable Chain Mounts/[a] Y Drag Chain Mount x1.stl" })
...
printables.push({ path: ["Mainboard_mount"], instruction: instructions.print.primary, stl: "Electronics Table/Mainboard Mount x1.stl" })
printables.push({ path: ["Cable_channel_"], instruction: instructions.print.primary, stl: "Electronics Table/Cable Channel x1.stl" })
